...
from tserve.settings import ModelSettings
...
ENV_PREFIX_HUGGINGFACE_SETTINGS = "TSERVER_MODEL_HUGGINGFACE_"
...
def merge_huggingface_settings_extra(model_settings: ModelSettings, 
                                     env_params: ExtraDict) -> ExtraDict:
    """
