...
def main(args):
    ...
    with strategy.scope():
        ...
        x = Dense(classes_num, activation="softmax")(last)
        finetuned_model = Model(model.input, x)
        finetuned_model.compile(optimizer=Adam(learning_rate=LEARNING_RATE), loss='categorical_crossentropy', metrics=['accuracy'])
...
def parse_arguments():
    ...
    parser.add_argument('--workload_name', type=str, required=False, default='resnet')
