...
public class ExperimentController {
    ...
    public HttpResponse infer(@Valid @RequestBody InferenceDataVO inferenceData) {
        ...
        String inferenceResult = experimentService.infer(inferenceData.getId(), inferenceData.getInstances());
